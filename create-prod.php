...
<body>
		...
		<div id="sec1">
			<div style="margin-top: 10px;">
				...
				<div id="logo-txt">
					...
					<h1 style="color: #4318FF;">Create New Product</h1>
				</div>
			</div>
		</div>
		<div id="sec2">
	...
	<div id="tassign">
	<?php
	echo"<div class='assign-ticket'><center><h3 style='display:block;font-weight: 400;font-size: 30px;line-height:2;color: #A3AED0;'>Create product</h3></center><form action='' method='POST' class='leave-form' id='leave-form'><label style='display:block;'>Product Name</label><input  placeholder='Product name' type='text' name='pname' class='leave-reason' id='leave-reason' form='leave-form' required><br><label>Product amount</label><br><input type='tel' name='pamount' class='leave-reason' id='leave-reason' form='leave-form' placeholder='Income' required><br><label style='display:block;'>Profit</label><input  placeholder='Profit' type='tel' name='pprofit' class='leave-reason' id='leave-reason' form='leave-form' required><br><label style='display:block;'>Number of products</label><input  placeholder='Products' type='tel' name='pquantity' class='leave-reason' id='leave-reason' form='leave-form' required><button type='submit' form='leave-form' value='Apply' class='apply-leave-btn' name='submit'>Create</button></div></form></div></div>";
	?>
	</div>
</body>
<?php
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO `product`(`pname`, `pamount`, `pprofit`, `pquantity`) VALUES ('$name','$amount','$profit','$quantity')";
	$conn->query($sql);
