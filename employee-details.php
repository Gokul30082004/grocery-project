...
<body>
	...
	<div class="buttons">
	       <input type='hidden' style='float:left; border-radius:6px;padding:2px;margin-top:20px;' placeholder='Search here' id='search-btn' name='search_btn'>
	    <a href='delete-emp.php' id="cticket" style='text-decoration:none;padding:10px;'>Delete Employee</a>
	    <a href='create-emp.php' id="cticket" style='text-decoration:none;padding:10px;'>Create Employee</a>
	   ...
	   <table class="table-data" id="table-data">
	       ...
	       <tr>
			  ...
			  { 
			  	echo"<tr><td>".$emp['eid']."</td><td><a style='text-decoration:none;' class='table-hover'href=''>".$emp['ename']."</a></td><td>".$emp['esalary']."</td><td>".$emp['eaccount']."</td><td>".$emp['eaddress']."</td><td>".$emp['ephn']."</td></tr>";
			  }
				?>
			</tbody>
    </table>
    </div>
    <div id="card" style='margin-top:-40px;'>
	<?php
		$sql="select * from emp";
		$result=$conn->query($sql);
		while($emp=$result->fetch_assoc())
		{
    		echo"<a class='course-card' style='margin-top:50px;' href='edit-prof.php?id=".$emp['eid']."'><p class='course-card-progress' style='background-color:red;'>".$emp['eid']."</p><h1 class='course-card-title' style='margin-top: 15px;'>".$emp['ename']."</h1><div style='float:left;margin-top: 0px;width:70%'><p class='course-card-details'><i class='bi bi-bar-chart-fill'></i>Salary: ".$emp['esalary']."</p><p class='course-card-details'><i class='bi bi-tv-fill'></i>Employee id: ".$emp['eid']."</p><p class='course-card-details'><i class='bi bi-arrow-right-circle-fill'></i> Address   :".$emp['eaddress']."</p></div><div style='float:right;margin-top: 0px;width:60px;'></div></a>";
		}
		?></div>
	<script>
 var mleft = "closed";
  document.addEventListener('DOMContentLoaded', function() {
    const toggleButton = document.getElementById('table-view');
    const view1 = document.getElementById('card');
    const view2 = document.getElementById('table');
    
    toggleButton.addEventListener('click', function() {
      if (view1.style.display === 'none') {
        view1.style.display = 'block';
        view2.style.display = 'none';
        document.getElementById('search-btn').type='hidden';
        toggleButton.innerText = 'Table View';
      }
      else {
        view1.style.display = 'none';
        view2.style.display = 'block';
        document.getElementById('search-btn').type='text';
        toggleButton.innerText = 'Card View';
      }
    });
  });
</script>
