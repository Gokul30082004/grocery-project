...
<body>
	...
	<div id="side-bar">	
		<div id="side-menu">
			...
			<a href="edit-emp.php" class="side-menu-btn active">
		...
		<div id="sec1">
			<div style="margin-top: 10px;">
				...
				<div id="logo-txt">
					...
					<h1 style="color: #4318FF;">Update Product</h1>
				</div>
			</div>
		</div>
		<div id="sec2">
	...
	<div id="tassign">
	<div class='assign-ticket'><center><h3 style='display:block;font-weight: 400;font-size: 30px;line-height:2;color: #A3AED0;'>Update Product quantity</h3></center><form action='' method='POST' class='leave-form' id='leave-form'><label style='display:block;'>Product Name</label><input  placeholder='Product name' type='text' name='pname' class='leave-reason' id='input' form='leave-form' ><ul class='list'></ul><br><label style='display:block;'>Quantity</label><input  placeholder='Quantity' type='tel' name='pquantity' class='leave-reason' id='leave-reason' form='leave-form' ><br><button type='submit' form='leave-form' name='submit' value='Apply' class='apply-leave-btn'>Update</button></div></form></div></div>
	</div>
	<?php
...

	{
		...
		$pname=$_POST['pname'];
		$sql="UPDATE product SET pquantity='$pquantity' WHERE pname='$pname'";
		$conn->query($sql);
