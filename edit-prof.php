...
<body>
  ...
  <div id="side-bar"> 
    <div id="side-menu">
      ...
      <a href="employee-details.php" class="side-menu-btn active">
  ...
  <div id="main-area">
      <div style="margin-top: 10px;">
        ...
        <div id="logo-txt">
          ...
          <h1 style="color: #4318FF;">Employee Profile</h1>
        </div>
      </div>
    </div>
  ...
  <div>
    <?php
    $i=$_GET['id'];
    $sql="select * from emp where eid='$i'";
    ...
    ?>
        ...
        {
          echo"<header style='font-weight: 400;font-size: 30px;line-height: 1.5;color: #A3AED0;'><span id='yourp'>Employee profile</span></header><form action='' method='POST'><input type='button' onclick='edit()' class='edit-profile-button' style='float:right;width:60px;font-size:10px; margin-top:0px;' value='Edit Profile' id='edtprof'><br><br><table class='edit-profile-table'><tr><td><span>Name:     </span></td><td><input type='text' value=".$emp['ename']." readonly name='ename'id='ename'></td></tr><tr><td><span>Department:     </span></td><td><input readonly name='edept' type='text' value=".$emp['edept']." id='edept'></td></tr><tr><td><span>Employee id:     </span></td><td><input type='text' value=".$emp['eid']." readonly style='background-color:#D4FBFC;'name='eid'></td></tr><tr><td><span>Phone No:     </span></td><td><input type='tel' readonly value=".$emp['ephn']." name='ephone' id='ephone'></td></tr><tr><td><span>Account number:     </span></td><td><input readonly id='eemail' type='text' value=".$emp['eaccount']." name='eaccount'></td></tr><tr><td><span>Address:     </span></td><td><input readonly id='eaddress' type='text' value=".$emp['eaddress']." name='eaddress'></td></tr><tr><td><span>Salary:     </span></td><td><input readonly id='esalary' type='text' value=".$emp['esalary']." name='esalary'></td></tr></table><br><button type='submit' value='Save' class='edit-profile-button-save' name='submit'>Save</button> <br><br></form>";
        }
        ?>    
		    </div> 
		    </div>
        ...
        if(isset($_POST['submit']))
        {
          ...
          $sql="UPDATE `emp` SET `ename`='$ename',`edept`='$edept',`ephn`='$ephn',`eaccount`='$eaccount',`eaddress`='$eaddress',`esalary`='$esalary' WHERE eid='$i'";
          $result=$conn->query($sql);
          echo"<script>window.alert('Updated');window.location.href='employee-details.php';</script>";
        }
        ?>
  </body>
  <script>
    ...
    function edit(){
        if(ed!='view')
        {
            ...
            document.getElementById("edept").readOnly=true;
            document.getElementById("ephone").readOnly=true;
            document.getElementById("eemail").readOnly=true;
            document.getElementById("eaddress").readOnly=true;
            document.getElementById("esalary").readOnly=true;
            document.getElementById("edtprof").value='Edit profile';
            ed='view';
        }
        else{
            
            document.getElementById("ename").readOnly=false;
            document.getElementById("edept").readOnly=false;
            document.getElementById("ephone").readOnly=false;
            document.getElementById("eemail").readOnly=false;
            document.getElementById("eaddress").readOnly=false;
            document.getElementById("esalary").readOnly=false;
            document.getElementById("edtprof").value='View profile';
            ed='hide';
        }
    }
  </script>
