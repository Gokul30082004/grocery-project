...
<body>
	...
	<div id="side-bar">	
		<div id="side-menu">
			...
			<a href=".php" class="side-menu-btn">
	...
	<div id="tassign">
	<div class='assign-ticket'><center><h3 style='display:block;font-weight: 400;font-size: 30px;line-height:2;color: #A3AED0;'>Delete Employee</h3></center><form action='' method='POST' class='leave-form' id='leave-form'><label style='display:block;'>Employee Name</label><input  placeholder='Employee name' type='text' name='eid' class='leave-reason' id='leave-reason' form='leave-form' required><br><button type='submit' form='leave-form' value='Apply' class='apply-leave-btn' name='submit'>Delete</button></div></form></div></div>
	</div>
</body>
<?php
if(isset($_POST['submit']))
{
	$i=$_POST['eid'];
	echo"ujtf";
	$sql="DELETE FROM emp WHERE ename='$i'";
