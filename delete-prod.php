...
<body>
	...
	<div id="tassign">
	<?php echo"<div class='assign-ticket'><center><h3 style='display:block;font-weight: 400;font-size: 30px;line-height:2;color: #A3AED0;'>Delete product</h3></center><form action='' method='POST' class='leave-form' id='leave-form'><label style='display:block;'>Product Name</label><input  placeholder='Product name' type='text' name='pname' class='leave-reason' id='leave-reason' form='leave-form' required><br><button type='submit' form='leave-form' name='submit' value='Apply' class='apply-leave-btn'>Delete</button></div></form></div></div>";?>
	</div>
	<?php
	if(isset($_POST['submit']))
	{
		$i=$_POST['pname'];
		$sql="DELETE FROM product WHERE pname='$i'";
